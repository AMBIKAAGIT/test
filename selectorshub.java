...
//product page		
		 @Test
			 public void sh2() throws InterruptedException{
			 {
...
//	preplans	 
@Test
public void sh4() throws InterruptedException{
	{
System.setProperty("WebDriver.chrome.driver", "C:\\Users\\USER\\Downloads\\chromedriver-win64\\chromedriver-win64");
	WebDriver driver=new ChromeDriver();
	driver.get("https://selectorshub.com/xpath-practice-page/");
...
//resources page
      @Test
public void sh3() throws InterruptedException{
	{
System.setProperty("WebDriver.chrome.driver", "C:\\Users\\USER\\Downloads\\chromedriver-win64\\chromedriver-win64");
	WebDriver driver=new ChromeDriver();
	driver.get("https://selectorshub.com/xpath-practice-page/");
...
//help page
@Test
public void sh8() throws InterruptedException{
	{
...
//footer
@Test
public void sh5() throws InterruptedException{
	{
...
//practice page
@Test
public void sh9() throws InterruptedException{
	{
System.setProperty("WebDriver.chrome.driver", "C:\\Users\\USER\\Downloads\\chromedriver-win64\\chromedriver-win64");
	WebDriver driver=new ChromeDriver();
	driver.get("https://selectorshub.com/xpath-practice-page/");
